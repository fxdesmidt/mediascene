...
Muse.Utils.initWidget('#pamphletu641', function(elem) {
    new WebPro.Widget.ContentSlideShow(
        elem,
        {
            contentLayout_runtime:'stack',
